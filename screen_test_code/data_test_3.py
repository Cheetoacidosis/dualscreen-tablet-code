...
cs_dev = DigitalOutputDevice(pin=cs_pin, active_high=False, initial_value=True)
...
cd_dev.on()
spi.writebytes([0x0F]) #default settings, but in B/W mode
cs_dev.off()
